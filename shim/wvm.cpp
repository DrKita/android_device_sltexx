...
int _ZN7android16MediaBufferGroupC1Ej(void);
int _ZN7android16MediaBufferGroupC1Ev(void)
{
    return _ZN7android16MediaBufferGroupC1Ej();
}

size_t _ZN7android16MediaBufferGroup14acquire_bufferEPPNS_11MediaBufferEbj(MediaBuffer **buffer, bool nonBlock, size_t reqSize);
size_t _ZN7android16MediaBufferGroup14acquire_bufferEPPNS_11MediaBufferEb(MediaBuffer **buffer, bool nonBlock, size_t reqSize)
{
